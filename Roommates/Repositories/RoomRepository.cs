        ...
        public void Insert(Room room)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    int id = (int)cmd.ExecuteScalar(); //The cmd.ExecuteScalar method does two things: First, it executes the SQL command against the database. Then it looks at the first thing that the database sends back (in our case this is just the Id it created for the room) and returns it.
